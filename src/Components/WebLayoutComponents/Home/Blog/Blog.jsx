...
const Blog = () => {
   ...
   const description = "Enhance your sales prowess with practical techniques focused on communication, negotiation, and customer relations. This course offers actionable insights for achieving greater success in sales."
   return (
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5 md:gap-3 px-[2.5px] lg:px-[8%] xl:px-0'>
               ...
               <div className='min-w-[370px] max-w-[420px] h-[540px] shadow hover:shadow-[0px_4px_16px_rgba(17,17,26,0.1),_0px_8px_24px_rgba(17,17,26,0.1),_0px_16px_56px_rgba(17,17,26,0.1)] rounded overflow-hidden hover:-translate-y-1 duration-700 group'>
                  ...
                  <div className='p-5 flex flex-col justify-between'>
                     ...
                     <h4 className=' mb-5 text-gray-600'>{description.slice(0, 85)} ...</h4>
               ...
               <div className='min-w-[370px] max-w-[420px] h-[540px] shadow hover:shadow-[0px_4px_16px_rgba(17,17,26,0.1),_0px_8px_24px_rgba(17,17,26,0.1),_0px_16px_56px_rgba(17,17,26,0.1)] rounded overflow-hidden hover:-translate-y-1 duration-700 group'>
                  <div className='relative'>
                     <Image src={img2} alt='Blog Image' height="fill" width="fill" className='rounded-t group-hover:scale-105 transition duration-500' />
                     <p className='absolute py-1 px-3 bg-primary text-white rounded-md top-3 left-3'>Feb 20, 2024</p>
                  </div>
                  <div className='p-5 flex flex-col justify-between'>
                     <p className='py-1 px-3 bg-primary max-w-max rounded-3xl text-sm text-white mb-2'>Digital Marketing</p>
               ...
               <div className='min-w-[370px] max-w-[420px] h-[540px] shadow hover:shadow-[0px_4px_16px_rgba(17,17,26,0.1),_0px_8px_24px_rgba(17,17,26,0.1),_0px_16px_56px_rgba(17,17,26,0.1)] rounded overflow-hidden hover:-translate-y-1 duration-700 group'>
                  <div className='relative'>
                     <Image src={img3} alt='Blog Image' height="fill" width="fill" className='rounded-t group-hover:scale-105 transition duration-500' />
                     <p className='absolute py-1 px-3 bg-primary text-white rounded-md top-3 left-3'>Feb 20, 2024</p>
                  </div>
                  <div className='p-5 flex flex-col justify-between'>
                     <p className='py-1 px-3 bg-primary max-w-max rounded-3xl text-sm text-white mb-2'>Digital Marketing</p>
