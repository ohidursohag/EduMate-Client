...
const ShareButton = () => {
  ...
  return (
    <div ref={refWraper} className={`flex justify-center items-center w-[165px] duration-500 m-1 `}>
      {/* Social Link */}
      <div className={`relative  bg-primary flex justify-start items-center gap-2 transition  duration-500 w-[165px] h-9  py-1 px-2 rounded-2xl ${shareOpen ? " translate-x-[30px] scale-x-100 opacity-100" : " scale-x-0 translate-x-[70%] opacity-0"}`}>
