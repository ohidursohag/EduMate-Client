...
const ShareButton = () => {
   ...
   return (
      <div className='flex justify-center items-center gap-2'>
         ...
         {
            shareOpen ? <button onClick={() => setShareOpen(!shareOpen)}><IoMdClose style={{ color: "black" }} className='p-1 shadow-md rounded-full text-4xl' /></button> : <button onClick={() => setShareOpen(!shareOpen)} className='hover:shadow-[rgba(0,_0,_0,_0.4)_0px_30px_90px] rounded-full hover:bg-primary '>
