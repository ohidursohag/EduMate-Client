    ...
    <div className="flex   gap-5">
      ...
      <div className="group">
        {user ? (
          ...
          <Image className="object-cover w-10 h-10 object-bottom duration-300 group-hover:scale-110" width={40} height={40} src={'https://i.ibb.co/7yY9hv0/26159-removebg-preview.png'} alt="Profile image" />
        </figure>
        ) : (
          <Link href={''} className="xl:text-xl mx-auto md:mx-0 w-max px-5 py-2 bg-primary text-white relative overflow-hidden group z-10 rounded-lg shadow-md flex items-center gap-2">
